...
# 3 channel条件 crop
def subject_data_3C_crop(sub_dir):
    print(sub_dir)
    # 140, 140, 96, n
    ...
    # b5000 = b5000 / 300
    # b10000 = b10000 / 200
    b1000 = np.log(b1000) / 6
    b3000 = np.log(b3000) / 6
    b5000 = np.log(b5000) / 6
    b10000 = np.log(b10000) / 6
...
for file in sub_list:
    ...
    low_b_DWI, high_b_DWI = subject_data_3C_crop(sub_folder)
...
low_b_DWI_file = h5py.File('/data/wtl/SR_Data/low_b_DWI_3C_Crop.h5', 'w')
high_b_DWI_file = h5py.File('/data/wtl/SR_Data/high_b_DWI_3C_Crop.h5', 'w')
