...
sub_list = sorted(os.listdir(dataset_path))[:10]
...
low_b_DWI_file = h5py.File('/data/wtl/SR_Data/low_b_DWI_3C_Crop_b0.h5', 'w')
high_b_DWI_file = h5py.File('/data/wtl/SR_Data/high_b_DWI_3C_Crop_b0.h5', 'w')
